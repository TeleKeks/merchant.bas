...
3100  REM IF X$ = "O" THEN MMAP$(I) = MMAP$(I) + CHR$(27) + "[38;5;088m" + X$
 ...
 3710  FOR I = 0 TO 12
 3720  PRINT KEK$;
 3730  IF I = 6 THEN PRINT MID$(MAP$(PLAYERY-1),(PLAYERX-15),15) + CHR$(27) + "[48;5;247m" + MID$(MAP$(PLAYERY-1),(PLAYERX),1) + CHR$(27) + "[48;5;232m" + MID$(MAP$(PLAYERY-1),(PLAYERX+1),15) + KEK$;
 3740  IF I <> 6 THEN PRINT MID$(MAP$(I + PLAYERY - 7),(PLAYERX-15),31) + KEK$;
 ...
 3770  IF I = 0 THEN PRINT CHR$(27) + "[38;5;28m" + TAB$(4) + "GOODS:" + CHR$(27) + "[38;5;252m"
 3780  NEXT I
 ...
 8180  IF I <> (PLAYERY-1) THEN PRINT MAP$(I)
 8190  IF I = (PLAYERY-1) THEN PRINT MID$(MAP$(PLAYERY-1),1,PLAYERX-1) + CHR$(27) + "[48;5;247m" + MID$(MAP$(PLAYERY-1),PLAYERX,1) + CHR$(27) + "[48;5;232m" + MID$(MAP$(PLAYERY-1),PLAYERX+1,80-PLAYERX)
 8200  NEXT I
