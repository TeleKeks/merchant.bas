...
3100  REM IF X$ = "O" THEN MMAP$(I) = MMAP$(I) + CHR$(27) + "[38;5;088m" + X$
 ...
 8190  IF I = (PLAYERY-1) THEN PRINT MID$(MAP$(PLAYERY-1),1,PLAYERX-1) + CHR$(27) + "[48;5;247m" + MID$(MAP$(PLAYERY-1),PLAYERX,1) + CHR$(27) + "[48;5;232m" + MID$(MAP$(PLAYERY-1),PLAYERX+1,79-PLAYERX)
 8200  NEXT I
